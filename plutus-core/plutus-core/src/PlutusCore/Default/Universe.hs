...
instance GEqL DefaultUni (Esc Integer) where
    geqL DefaultUniInteger = Just Refl
    geqL _                 = Nothing

instance GEqL DefaultUni (Esc BS.ByteString) where
    geqL DefaultUniByteString = Just Refl
    geqL _                    = Nothing

instance GEqL DefaultUni (Esc Text.Text) where
    geqL DefaultUniString = Just Refl
    geqL _                = Nothing

instance GEqL DefaultUni (Esc ()) where
    geqL DefaultUniUnit = Just Refl
    geqL _              = Nothing

instance GEqL DefaultUni (Esc Bool) where
